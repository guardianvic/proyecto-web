...
{   
   ...
   private function hashPassword($password)
    {
    return password_hash(empty($password) ? passGenerator() : $password, PASSWORD_BCRYPT);
    }
    ...
    try {
        if ($_POST) {
            ...
            $strPassword = empty($_POST['txtPassword']) ? "" : $this->hashPassword($_POST['txtPassword']);
            ...
            if ($idUsuario == 0) {
                ...
                if (empty($strPassword)) {
                    ...
                    $strPassword = $this->hashPassword($_POST['txtPassword']); // Cifrar nueva contraseña
                }
